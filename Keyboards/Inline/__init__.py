...
from .main_menu import ikb_start, ikb_main
...
from .purchase import ikb_purchase_done

__add__ = ['ikb_confirm', 'ikb_main', 'ikb_all_courses', 'ikb_on_course', 'ikb_off_course', 'ikb_individual',
           'ikb_settings', 'ikb_links', 'ikb_courses_my', 'ikb_course_my_navigation',
           'ikb_select_type', 'ikb_select_level', 'ikb_select_task',
           'ikb_notification', 'ikb_user_notification', 'ikb_purchase_done']
