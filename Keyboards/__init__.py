...
from .Inline import ikb_confirm, ikb_start, ikb_main, ikb_all_courses, ikb_on_course, ikb_off_course, ikb_individual, \
    ikb_settings, ikb_links, ikb_courses_my, ikb_course_my_navigation, ikb_purchase_done, \
...
__add__ = ['kb_control', 'kb_stream', 'kb_new_task',
           'ikb_confirm', 'ikb_start', 'ikb_main', 'ikb_purchase_done',
